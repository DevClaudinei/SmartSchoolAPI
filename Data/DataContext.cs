    ...
    public class DataContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            builder.Entity<StudentDiscipline>()
                .HasKey(x => new { x.StudentId, x.DisciplineId });

            builder.Entity<Teacher>()
                .HasData(new List<Teacher>(){
                    new Teacher(1, "Lauro", "Fernandes"),
                    new Teacher(2, "Roberto", "Solto"),
                    new Teacher(3, "Ronaldo", "Rabelo"),
                    new Teacher(4, "Rodrigo", "Meneses"),
                    new Teacher(5, "Alexandre", "Miguel"),
                });
